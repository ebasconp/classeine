...
#include <clsn/ui/layouts/FlowLayout.h>

namespace clsn::ui::layouts
{
    using namespace clsn::draw;

    void FlowLayout::doLayout(const draw::Region& rgn, LayoutElementInfoVector& elems) const
    {
        ...
        for (auto& e : elems)
        {
            ...
            if (currentx + control_width < maxx)
            {
                ...
                e.setOutputRegion({ {currentx, currenty}, preferred_size });
            }
            else
            {
