...
namespace clsn::ui::layouts
{
    ...
    void VBoxLayout::doLayout(const draw::Region& rgn, LayoutElementInfoVector& elems) const
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            elems[i].setOutputRegion({ {position.getX(), last_y + position.getY()}, {width, actual_height} });
